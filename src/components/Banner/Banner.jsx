...
const Banner = () => {
    return(
        <div>
            ...
            {/* text content */}
            <div className="bg-gradient-to-r from-[#8f8fdf]/40 to-[#3b3ba2]/0 p-6 rounded-lg absolute top-1/3 lg:top-1/3 md:w-7/12 left-4 md:left-8 lg:left-16">
                <h1 className="text-4xl lg:text-5xl lg:leading-tight mb-2 font-black text-white">Elevate Your <span className="text-[#3b3ba2]">Experience</span> with <span className="text-[#3b3ba2]">Seamless</span> User <span className="text-[#3b3ba2]">Management</span></h1>
